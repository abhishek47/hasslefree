...
class Booking extends Model
{
    ...
    {
        return '<a class="btn btn-xs btn-success" target="_blank" href="/bookings/' . $this->id . '/receipt' . '" data-toggle="tooltip" title="View/Download Booking Receipt"><i class="fa fa-file-text"></i> Receipt</a>';
    }
