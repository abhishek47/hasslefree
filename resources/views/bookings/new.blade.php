...
<div class="bg-light mini-spacer" style="min-height: 1000px;padding-top: 90px;">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 ">
                <form class="registration-form text-dark font-medium" method="POST" action="/bookings/new">
                    {{ csrf_field() }}
                    <fieldset style="display: block;">
                        <div class="card card-shadow">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-parsley-required  name="customer_name" class="form-control" placeholder="Full name of customer">

                                </div>

                                <div class="form-group">
                                    <label>Customer Phone No.</label>
                                    <input type="number" data-parsley-required  name="customer_phone" class="form-control" placeholder="Contact no. of customer">
                        ...
                        <div class="card card-shadow">
                            <div class="card-body">
                                <h3 class="panel-heading">Manual Booking Form</h3>
                                <hr>
