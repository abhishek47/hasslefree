...
@section('content')
    ...
    <div class="wrap-login100 p-l-50 p-r-50 p-t-30 p-b-30">
                <form class="login100-form validate-form" method="POST" action="{{ url('start/register') }}">
                    {{ csrf_field() }}
                    ...
                    @endif
                     ...
                     <div class="wrap-input100 m-b-16" >
                        <input class="input100" type="text" name="phone" value="{{ session('phoneNum') }}" placeholder="Phone Number">
                    ...
                    <div class="wrap-input100 m-b-16" >
                        <input class="input100" type="text" name="email" placeholder="Enter Your Email (optional)">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
